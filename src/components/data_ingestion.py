...
class DataIngestionConfig:
    train_data_path: str=os.path.join('artifacts',"train.csv") #class variable
    test_data_path: str=os.path.join('artifacts',"test.csv") #class variable
    raw_data_path: str=os.path.join('artifacts',"data.csv") #class variable
